...
public class Date212 implements Comparable<Date212> 
{
      ...
      {	
            ...
            else throw new Date212Exception(" is an invalid date.");
            return false;
      }
      
      //Checks in order, for the year, month and day. If the return value greater than 0, we know that the 1st date is older than the 2nd date which requires a switch.
      //OVERRIDING the COMPARABLE of the TreeMap which allows for TreeMaps objects to compared using this compareTo method. 
      @Override
